...
import time
import random
from service.ocr_service.ocr_service import extract_text_from_image
...
def upload_resume():
    ...
    try:
        ...
        # 2. 呼叫真正的 OCR
        raw_ocr_result = extract_text_from_image(filepath)
        
        # 3. 數據映射 (Mapping)
        # 改名為 res_struct 避免跟系統庫 struct 衝突
